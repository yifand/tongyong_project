...
public class AlarmController {
    ...
    public ApiResponse<PageApiResponse<AlarmResponse>> getHistoryAlarms(
...
public interface AlarmService {
     ...
     * 历史预警分页查询
     */
    PageApiResponse<AlarmResponse> getHistoryAlarms(AlarmHistoryRequest request);
...
public class AlarmServiceImpl implements AlarmService {
    ...
    @Override
    public PageApiResponse<AlarmResponse> getHistoryAlarms(AlarmHistoryRequest request) {
        // 获取当前用户的数据权限范围
        Set<Long> siteIds = getCurrentUserSiteIds();
    ...
    public AlarmResponse getAlarmDetail(Long id) {
        AlarmRecord alarm = alarmRepository.findById(id)
                .orElseThrow(() -> new BusinessException(ResultCode.ALARM_NOT_FOUND));
    ...
    public void processAlarm(Long id, AlarmProcessRequest request) {
        ...
        // 校验状态
        if (alarm.getStatus() == AlarmStatusEnum.PROCESSED) {
            throw new BusinessException(ResultCode.ALARM_ALREADY_PROCESSED);
        }

        // 更新状态
        alarm.setStatus(AlarmStatusEnum.PROCESSED);
    ...
    public void markFalsePositive(Long id, AlarmProcessRequest request) {
        ...
        // 更新状态
        alarm.setStatus(AlarmStatusEnum.FALSE_POSITIVE);
        alarm.setProcessorId(SecurityUtils.getCurrentUserId());
        alarm.setProcessedAt(LocalDateTime.now());
        alarm.setRemark(request != null ? request.getRemark() : null);
    ...
    public AlarmRecord createAlarm(AlarmCreateEvent event) {
        ...
        alarm.setStatus(AlarmStatusEnum.UNPROCESSED);
...
引用公共基础模块枚举：
- `com.vdc.pdi.common.enums.AlarmTypeEnum`
- `com.vdc.pdi.common.enums.AlarmStatusEnum`
...
// 方案3：预估总数+限制最大偏移量
public PageApiResponse<AlarmResponse> getHistoryWithLimit(AlarmHistoryRequest request,
                                                      Set<Long> siteIds) {
    // 限制最大偏移量为10000
    ...
    if (offset > MAX_OFFSET) {
        // 超过限制时，提示用户缩小时间范围
        throw new BusinessException(ResultCode.QUERY_RANGE_TOO_LARGE,
                "查询范围过大，请缩小时间范围");
    }
...
class AlarmServiceTest {
    ...
    class HistoryAlarmTests {
        ...
        void shouldSupportComplexQuery() {
            ...
            // When
            PageApiResponse<AlarmResponse> result = alarmService.getHistoryAlarms(request);
